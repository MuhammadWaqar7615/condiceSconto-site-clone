...
export default function CouponCard({ coupon }) {
  ...
  return (
    <div className="bg-white rounded-xl shadow-[0_2px_10px_-3px_rgba(6,81,237,0.1)] border border-gray-100 hover:border-[#835674]/30 hover:shadow-lg transition-all duration-300 flex flex-col md:flex-row overflow-hidden group">
      ...
      <div className="w-full md:w-[180px] bg-gradient-to-b from-[#fdfbfd] to-[#f8f4f7] md:border-r-2 md:border-dashed border-gray-200 flex flex-col items-center justify-center p-6 flex-shrink-0 relative">
        ...
        <span className="text-[12px] font-bold text-[#835674] uppercase tracking-widest mb-1 mt-2 md:mt-0">
      ...
      <div className="flex-1 p-6 md:p-8 flex flex-col justify-center">
        <h3 className="text-lg md:text-[22px] font-bold text-gray-800 mb-3 hover:text-[#835674] cursor-pointer transition-colors leading-snug">
          {coupon.title}
        </h3>
      ...
      {/* Right Action Button */}
      <div className="w-full md:w-[220px] p-6 flex flex-col items-center justify-center border-t md:border-t-0 md:border-l border-gray-100 bg-[#fafafa]/50">
        {showCode ? (
          <div className="w-full flex flex-col gap-2">
            <div 
              onClick={handleCopyCode}
              className="w-full border-2 border-dashed border-[#835674] bg-white text-[#835674] text-center font-mono text-[16px] font-bold py-3 px-2 rounded-lg cursor-pointer hover:bg-purple-50 hover:scale-[1.02] active:scale-[0.98] transition-all shadow-sm relative group"
            ...
            <a 
              ...
              className="text-xs text-center text-gray-500 hover:text-[#835674] underline underline-offset-2 mt-1"
            >
              Vai al negozio
            </a>
          </div>
          ...
          <button 
            ...
            className="w-full bg-[#835674] hover:bg-[#6c4660] text-white text-[14px] font-bold py-3.5 px-4 rounded-lg transition-all shadow-md hover:shadow-lg hover:-translate-y-0.5 active:translate-y-0 active:shadow-sm uppercase tracking-wide flex items-center justify-center gap-2"
          >
